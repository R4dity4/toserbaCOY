...
@section('content')
@php
    $categories = isset($produk) ? $produk->pluck('kategori')->filter()->unique()->sort() : collect();
@endphp
<style>
...
<div class="hero-banner mb-4">
    <div class="row align-items-center">
        ...
        <div class="col-md-5 text-center">
            <video autoplay muted loop playsinline class="img-fluid" style="border-radius:18px; box-shadow:0 14px 40px -10px rgba(0,0,0,.55); max-height:360px;">
        ...
        <div class="modal-content" style="border-radius:18px; overflow:hidden;">
          ...
          <div class="modal-body" style="background:#fafafa;">
            <div class="text-center mb-3">
              <img id="modalGambar" src="" alt="Gambar Produk" style="max-width:220px; border-radius:14px; box-shadow:0 8px 24px -8px rgba(0,0,0,.25);">
            </div>
